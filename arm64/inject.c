...
int main(int argc, char** argv) {
    ...
    //target_pid = find_pid_of("/data/test");
    inject_remote_process(target_pid, "/data/local/tmp/libTKHooklib.so ", "/data/local/tmp/libtrace_anti.so ", "hook_entry",  "I'm parameter!", strlen("I'm parameter!"));
    return 0;
}
